...
# Should be 0, Not Hired
#testCandidates = [array([10, 0, 3, 1, 0, 0])]


testData = sc.parallelize(testCandidates)

print(testData.top(10))

# trainingDataPrintOut = sc.parallelize(trainingData)
# print(trainingDataPrintOut.top(10))
